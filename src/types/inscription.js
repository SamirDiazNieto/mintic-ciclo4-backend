...
const inscriptionType = gql`
	...
	type Mutation {
		createInscription(student: ID!, project: ID!, state: String, dateRegister: Date, dateOut: Date): #comment:[String]
		String
		updateInscription(_id: ID!, state: String, dateRegister: Date, dateOut: Date): #comment:[String]
